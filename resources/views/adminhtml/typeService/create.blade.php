@section('title', 'Tạo Loại Dịch Vụ Mới ')
@include('main')
...
<div class="cat__content">
    ...
    <section class="card">
        <div class="card-header">
            ...
            <strong>Thêm Dịch Vụ mới</strong>
        </span>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                @endif
                <div class="col-lg-12">
                    {!! Form::open(array('route' => 'typeService.save','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')) !!}

                    <div class="row">
                        <div class="col-lg-12">
                            <label class="form-control-label">Tên Loại Dịch Vụ</label>
                            <input class="form-control"  placeholder="Điền tên dịch vụ"   name="ten_loai_dich_vu"  type="text" required>
                        </div>
                    </div>
