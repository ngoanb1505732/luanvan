@section('title', 'Chỉnh Sửa Liệu Trình')
@include('main')
...
<div class="cat__content">
    ...
    <section class="card">
        <div class="card-header">
            ...
            <strong>Chỉnh sửa Liệu trình</strong>
        </span>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-12 col-xs-12">
                    {!! Form::open(array('route' => 'process.update','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')) !!}
                    <input class="form-control" name="lieu_trinh_id" value="{{$lieutrinh->lieu_trinh_id}}"  type="text" >
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-12 form-group">
                            ...
                            <input class="form-control"  placeholder="Điền tên liệu trình"   name="ten_lieu_trinh" value="{{$lieutrinh->ten_lieu_trinh}}"  type="text" required>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6  col-xs-6 form-group">
                            ...
                            <select class="form-control" name="dich_vu_id">
                                @foreach($dichvu as $itemDichVu)
                                    @if($itemDichVu->dich_vu_id == $lieutrinh->dich_vu_id )
                                    <option value="{{$itemDichVu->dich_vu_id}}" selected>{{$itemDichVu->ten_dich_vu}}</option>
                                    @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xs-6 form-group">
                            ...
                            <input class="form-control"  placeholder="Điền giá tiền" value="{{$lieutrinh->gia_tien}}"   name="gia_tien"  type="text" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-xs-12">
                            <img id="preview-main-img" src="{{url("/")."/".$lieutrinh->anh_dai_dien}}" class="preview-img"/>
                        </div>
                        <div class="col-lg-12 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-xs-12">
                            <div class="row">
                                 @foreach($lieutrinh->hinhAnh as $item)
