...
<div class="cat__content">
    ...
    <section class="card">
        <div class="card-header">
            ...
            <strong>Cập Nhật Thông Tin Dịch Vụ </strong>
        </span>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <input value="{{$dichvu->dich_vu_id}}" class="form-control"    name="dich_vu_id"  type="text" hidden>
                    <div class="row">
                        <div class="col-lg-12">
                            <label class="form-control-label">Tên Dịch Vụ</label>
                            <input class="form-control"  placeholder="Điền tên dịch vụ" value="{{$dichvu->ten_dich_vu}}"   name="ten_dich_vu"  type="text" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <textarea name="dien_giai">{{$dichvu->dien_giai}}</textarea>
                        </div>
                    </div>
